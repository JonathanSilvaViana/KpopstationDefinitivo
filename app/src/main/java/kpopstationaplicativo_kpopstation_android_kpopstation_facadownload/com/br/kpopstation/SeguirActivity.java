...
public class SeguirActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                || CN.getNetworkInfo(ConnectivityManager.TYPE_WIFI).getState() == NetworkInfo.State.CONNECTED)
        {
            ...
            HTML = "<html><head><meta http-equiv='refresh' content='0;URL=https://kpopstation.com.br/novo/redessociais'></head><body>" + " <h3>  </h3> " + "</body></html>";
        ...
        {
            android.app.AlertDialog.Builder alertDialogBuilder = new android.app.AlertDialog.Builder(SeguirActivity.this);
            ...
            alertDialogBuilder
                    ...
                    .setNegativeButton("Não", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            ...
                            dialog.cancel();
                            Intent mandaparahomedenovo = new Intent(SeguirActivity.this, MainActivity.class);
