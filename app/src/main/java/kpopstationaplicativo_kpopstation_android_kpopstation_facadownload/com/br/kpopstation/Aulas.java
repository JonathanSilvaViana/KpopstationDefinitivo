...
public class Aulas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            android.app.AlertDialog.Builder alertDialogBuilder = new android.app.AlertDialog.Builder(Aulas.this);
            ...
            alertDialogBuilder
                    ...
                    .setNegativeButton("Não", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            ...
                            dialog.cancel();
                            Intent mandaparahomedenovo = new Intent(Aulas.this, MainActivity.class);
