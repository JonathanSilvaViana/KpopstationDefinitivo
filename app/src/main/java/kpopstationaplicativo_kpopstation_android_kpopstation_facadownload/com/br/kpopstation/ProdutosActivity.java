...
public class ProdutosActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HTML = "<html><head><meta http-equiv='refresh' content='0;URL=https://kpopstation.com.br/novo/produtos'></head><body>" + " <h3>  </h3> " + "</body></html>";
        ...
        {
            android.app.AlertDialog.Builder alertDialogBuilder = new android.app.AlertDialog.Builder(ProdutosActivity.this);
            ...
            alertDialogBuilder
                    ...
                    .setNegativeButton("Não", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            ...
                            dialog.cancel();
                            Intent mandaparahomedenovo = new Intent(ProdutosActivity.this, MainActivity.class);
